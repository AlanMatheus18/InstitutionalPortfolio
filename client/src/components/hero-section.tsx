  ...
  import invisa from "../../src/assets/imgs/Banner05.webp";
      ...
      >
        ...
        <div className="container mt-[20px] md:mt-[0px] md:mb-[-20px] px-20 relative z-10 w-2px">
          <h1 className="text-4xl font-montserrat font-bold mb-6 leading-tight">
            ...
            <span className="text-dental-secondary">Naturais</span> e{" "}
            <span className="text-dental-secondary">Duradouros</span>
          </h1>
